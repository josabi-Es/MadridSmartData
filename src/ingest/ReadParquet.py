...
loads them into a Spark DataFrame, caches it for faster processing, and prints basic information.
"""
...
def schema_ContaminationStation():
    schema = StructType([
        ...
        # coordenadas como string por el formato grados/minutos/segundos
        ...
        StructField("fecha_alta", StringType(), True),  # si luego haces conversión a fecha, puedes usar DateType
        StructField("coordenada_x_etrs89", StringType(), True),  # tiene coma decimal, mejor string y luego parsear
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .appName("PySpark Parquet Example - Contamination Data") \
        .master("local[8]") \
    ...
    input_path = "Your folder with Parquet files/*"

    # Read Parquet files using predefined schema
